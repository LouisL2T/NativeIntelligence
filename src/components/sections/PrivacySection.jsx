...
export function PrivacySection() {
  return (
    <section id="privacy" className="py-24 md:py-32 bg-white px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="flex flex-col items-center text-center mb-16 md:mb-24">
          <div className="liquid-glass rounded-full px-4 py-1.5 mb-6">
            <span className="text-black text-xs font-medium font-body uppercase tracking-wider">Data Privacy</span>
          </div>
        ...
        >
          ...
          {[
            ...
            <motion.div
              ...
              className="absolute liquid-glass rounded-full px-4 py-1.5 text-xs font-body font-medium text-black"
          ...
          {principles.map((p, idx) => (
            ...
            >
              <div className="liquid-glass-strong rounded-full w-10 h-10 flex items-center justify-center shrink-0 mt-0.5">
                <p.icon className="w-4 h-4 text-black" />
              </div>
              <div>
                <h3 className="font-heading italic text-lg text-black mb-1">{p.title}</h3>
                <p className="text-black/60 font-body font-light text-sm leading-relaxed">{p.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
