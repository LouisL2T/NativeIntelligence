      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-16 md:mb-24">
          <div className="liquid-glass rounded-full px-4 py-1.5 mb-6">
            <span className="text-black text-xs font-medium font-body uppercase tracking-wider">Über uns</span>
          </div>
        ...
        >
          ...
          <blockquote className="relative text-2xl md:text-3xl lg:text-4xl font-heading italic text-black leading-[1.1] max-w-4xl mx-auto">
            "Wir bauen keine Websites. Wir bauen digitale Maschinen, die für Ihr Business arbeiten — während Sie schlafen."
          </blockquote>
          <div className="mt-8 text-black/40 font-body text-sm">— Native Intelligence, gegründet 2024</div>
        </motion.div>
          ...
          {team.map((member, i) => (
            ...
            >
              ...
              <div className="w-14 h-14 liquid-glass-strong rounded-full flex items-center justify-center">
                <span className="font-heading italic text-xl text-black">{member.initials}</span>
              </div>
              <div>
                <div className="font-heading italic text-xl text-black">{member.name}</div>
                <div className="text-black/50 font-body text-sm mt-0.5">{member.role}</div>
              </div>
              <p className="text-black/60 font-body font-light text-sm leading-relaxed">{member.desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        <div className="flex flex-col items-center text-center mb-12">
          <h3 className="text-3xl md:text-4xl font-heading italic text-black">Unsere Werte.</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {values.map((v, i) => (
            ...
            >
              ...
              <div>
                <h4 className="font-heading italic text-lg text-black mb-1">{v.title}</h4>
                <p className="text-black/60 font-body font-light text-sm leading-relaxed">{v.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
