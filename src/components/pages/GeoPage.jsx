    ...
    <div className="bg-white min-h-screen text-foreground antialiased selection:bg-black/30 selection:text-[#1e294d]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}
              ...
              <div className="relative rounded-3xl overflow-hidden border border-[#1e294d]/8 shadow-xl bg-gradient-to-br from-blue-50 to-slate-100 h-80">
                {/* Grid lines */}
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-[#213979] rounded-full flex items-center justify-center shadow-lg">
                ...
                {[
                  ...
                  <motion.div key={i}
                    ...
                    className="absolute liquid-glass rounded-xl px-3 py-1.5 text-xs font-body font-medium text-[#1e294d] whitespace-nowrap"
            ...
            <div className="flex-1">
              <div className="liquid-glass rounded-full px-4 py-1.5 mb-6 inline-block">
                <span className="text-[#1e294d] text-xs font-medium font-body uppercase tracking-wider">Ergebnisse</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-heading italic text-[#1e294d] leading-[0.9] mb-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                    ...
                    <div className="text-3xl md:text-4xl font-heading italic text-[#1e294d] mb-1">{stat.val}</div>
                    <div className="text-[#1e294d]/50 font-body text-sm">{stat.label}</div>
                  </motion.div>
                ))}
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center mb-16">
            <div className="liquid-glass rounded-full px-4 py-1.5 mb-6">
              <span className="text-[#1e294d] text-xs font-medium font-body uppercase tracking-wider">Überall gefunden</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-heading italic tracking-tight leading-[0.9] text-[#1e294d]">Auf jedem Kanal. An erster Stelle.</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {geoSignals.map((sig, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: sig.delay }}
                ...
                <div className="text-3xl font-heading italic text-[#1e294d]">{sig.rank}</div>
                <div className="text-[#1e294d]/60 font-body text-sm">{sig.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-heading italic tracking-tight leading-[0.9] text-[#1e294d]">So machen wir Sie zur #1.</h2>
          </div>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center mb-16">
            <div className="liquid-glass rounded-full px-4 py-1.5 mb-6">
              <span className="text-[#1e294d] text-xs font-medium font-body uppercase tracking-wider">Leistungen</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-heading italic tracking-tight leading-[0.9] text-[#1e294d]">Vollständige GEO-Abdeckung.</h2>
          </div>
