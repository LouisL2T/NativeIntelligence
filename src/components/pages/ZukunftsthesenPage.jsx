...
export function ZukunftsthesenPage() {
  return (
    <div className="bg-white min-h-screen text-foreground antialiased selection:bg-[#213979]/30 selection:text-[#1e294d]">
      <Navbar />
      <section id="zukunft" className="py-32 md:py-40 bg-white px-6 md:px-12 lg:px-24">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="flex flex-col items-center text-center mb-16 md:mb-24">
            <div className="liquid-glass rounded-full px-4 py-1.5 mb-6">
              <span className="text-[#1e294d] text-xs font-medium font-body uppercase tracking-wider">Zukunftsthesen</span>
            </div>
          ...
          <div className="flex flex-col gap-6">
            {theses.map((thesis, idx) => (
              ...
              >
                {/* Number */}
                <span className="font-heading italic text-5xl md:text-6xl text-[#1e294d]/10 shrink-0 leading-none pt-1">
                  {thesis.number}
                </span>
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-4 mb-4">
                    <h3 className="text-xl md:text-2xl font-heading italic text-[#1e294d] leading-tight">
                      {thesis.title}
                    </h3>
                    <span className="liquid-glass-strong rounded-full px-3 py-1 text-xs font-body font-medium text-[#1e294d]/50 uppercase tracking-wider shrink-0 hidden md:block">
                      {thesis.tag}
                    </span>
                  </div>
                  <p className="text-[#1e294d]/60 font-body font-light text-base leading-relaxed">
                    {thesis.body}
                  </p>
                  <span className="liquid-glass-strong rounded-full px-3 py-1 text-xs font-body font-medium text-[#1e294d]/50 uppercase tracking-wider mt-4 inline-block md:hidden">
                    {thesis.tag}
                  </span>
                </div>
              </motion.div>
